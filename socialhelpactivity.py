...
_logger = logging.getLogger('sugar-help-activity')
...
class Browser(activity.Activity):
	...
	self.set_size_request(400, 400)
        ...
        self.tabs.append((self._create_tab(), Gtk.Label("Social Help - Discourse")))
        self.notebook.append_page(*self.tabs[0])
        self.add(self.notebook)

	# connect signals
        self.connect("key-press-event", self._key_pressed_cb)
        self.notebook.connect("switch-page", self._tab_changed_cb)
